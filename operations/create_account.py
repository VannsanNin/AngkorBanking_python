...
def create_user_account(
    ...
    id_card_issue_date = id_card_issue_date.strip()
    id_card_expiry_date = id_card_expiry_date.strip()
    career = career.strip()
    ...
    if not bank._validate_date(id_card_issue_date):
        return {
            "success": False,
            "message": "ID card create date must be in YYYY-MM-DD format.",
        }
    if not bank._validate_date(id_card_expiry_date):
        return {
            "success": False,
